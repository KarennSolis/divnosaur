                ...
                <div className="row">
                    ...
                    <div className="col-md-8 col-sm-4 col-xs-4 float-end">
                        <div id="start-button" >
                            ...
                            <a href=""><button className="btn-inicio btn btn-outline-primary">Unirse ahora</button></a>
                            <a href=""><button className="btn-inicio btn btn-primary">Iniciar sesión</button></a>
