...
export function Perfil(props) {
    ...
    const handlePrevRecomendacion = () => {
        setRecomendacionActual((prevIndex) => (prevIndex === 0 ? recomendaciones.length - 1 : prevIndex - 1));
    };

    const handleNextRecomendacion = () => {
        setRecomendacionActual((prevIndex) => (prevIndex === recomendaciones.length - 1 ? 0 : prevIndex + 1));
    };
    ...
    //             // const user_id = followerData.user_id
    //             console.log("Nocheeeeeeeeeee" + user_id);
    //             console.log(user_id); 
    //             const response = await fetch(`http://localhost:3001/profile/recomendaciones/${user_id}`, {
    //                 method: 'GET',
    //                 headers: {
    //                     Authorization: `Bearer ${localStorage.getItem('Token')}`,
    //                     'Content-Type': 'application/json',
        ...
        return (
            <div>
                ...
                <div className="container  mothership-b">
                    <h1 className="tecler-perfil-b" id="perfilDeUsuario">Perfil de {followerData.name} </h1>
                    ...
                    <div className="card p-2 w-100 rounded-5 text-bg-info  border border-primary-subtle shadow">
                        <div className="row perfil-row-b">
                            <div className="col-5  colum-dat-usu">
                                ...
                                <p id="locationUser" className="p-perfil-b">{followerData.country}</p>
                            </div>
                            <div className="col-2">
                            ...
                            <div className="col-5">
                                <p className="text-center fw-bold">Recomendaciones de  {followerData.name}: </p>
                            </div>
                        </div>
                        <div className="row perfil-row-b">
                            <div className="col-5 colum-dat-usu">
                                <i className="bi bi-calendar bs-icon-b fs-4"></i>
                                <p id="profileBirth" className="p-perfil-b">{followerData.age}</p>
                            </div>
                            <div className="col-2">
                                <button className="text-info bg-dark rounded-1" disabled>
                                    Edad
                            ...
                            <div className="col-5">
                                ...
                                {recomendaciones.length === 0 ? (
                                    ...
                                    recomendaciones.map((recomendacion, index) => (
                                        <div className="text-center border-primary rounded-5 shadow bg-info-subtle p-2" key={recomendacion.recomendacion_ID} style={{ display: index === recomendacionActual ? 'block' : 'none' }}>
                                            <p className="bi bi-person-heart fw-bold"> {recomendacion.name}</p>
                                            <p className="bi bi-chat-left-quote fst-italic"> {recomendacion.contenido}</p>
                                            <button className="btn btn-outline-primary bi bi-caret-left-square-fill" onClick={handlePrevRecomendacion}></button>
                                            <button className="btn btn-outline-primary ms-5 bi bi-caret-right-square-fill" onClick={handleNextRecomendacion}></button>
                        ...
                        <div className="row perfil-row-b">
                            <div className="col-5 colum-dat-usu">
                                ...
                                <p id="profileStudy" className="p-perfil-b">{followerData.experience}</p>
                            </div>
                            <div className="col-2">
                                <button className="text-info bg-dark rounded-1" disabled>
                                    Experiencia
                            ...
                            <div className="col-5">
                                <p className="text-center fw-bold">Añade una recomendacion a {followerData.name} </p>
                            </div>
                        </div>
                        <div className="row perfil-row-b">
                            <div className="col-5 colum-dat-usu">
                                <i className="bi bi-person bs-icon-b fs-4"></i>
                                <p id="profileName" className="p-perfil-b">{followerData.name}</p>
                            </div>
                            <div className="col-2">
                                <button className="text-info bg-dark rounded-1" disabled>
                                    Nombre
                            ...
                            <div className="col-5">
                                {/* <textarea type="text" className="text-center w-100"></textarea> */}
                                {/* <form onSubmit={handleSubmit}>
                                    <textarea value={contenido} onChange={handleContenidoChange} />
                                    <button type="submit">Actualizar Recomendación</button>
                                </form> */}
                                {/* <textarea className="text-center w-100" value={nuevaRecomendacion} onChange={(e) => setNuevaRecomendacion(e.target.value)}></textarea> */}
                        ...
                        <div className="row perfil-row-b">
                            <div className="col-5 colum-dat-usu">
                                ...
                                <p id="profileHobbies" className="p-perfil-b">{followerData.hobbies}</p>
                            </div>
                            <div className="col-2">
                                <button className="text-info bg-dark rounded-1" disabled>
                                    Hobbies
                ...
                <div className="container  mothership-b">
                    ...
                    <div className="card p-0 w-100 rounded-5 bg-primary-subtle border border-primary-subtle shadow">
                        <div className="row perfil-row-b">
                            ...
                            <div className="col-5">
                                <h6 className=" rounded-1 d-flex justify-content-center mx-auto" disabled>
                                    Mis recomendaciones:
                                </h6>
                            </div>
                        </div>
                        <div className="row perfil-row-b">
                            ...
                            <div className="col-5">
                                {recomendaciones.length === 0 ? (
                                    <p className="bi bi-emoji-frown-fill fw-bold text-center">Aún no tienes recomendaciones</p>
                                ) : (
                                    recomendaciones.map((recomendacion, index) => (
                                        <div className="text-center border-primary rounded-5 shadow recoCard" key={recomendacion.recomendacion_ID} style={{ display: index === recomendacionActual ? 'block' : 'none' }}>
                                            <p className="bi bi-person-heart fw-bold"> {recomendacion.name}</p>
